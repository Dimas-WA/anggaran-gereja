                      ...
                      @if ($settings->count() > 0)
                          ...
                          <tr>
                              ...
                              <td>
                                ...
                                <td>
                                    <a class="btn btn-warning btn-xs text-white" href="{{ route('settings.show', $seksi->id) }}" id="submit-btn" style="background-color: #069fdb; border-color: #069fdb;"><i class="fas fa-search"></i> Review</a>
                                </td>
                          </tr>
