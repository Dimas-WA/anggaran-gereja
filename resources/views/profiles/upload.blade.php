...
@section('content-title')
    <h1 class="m-0 text-warning">Bulk Upload Create Profiles & Users</h1>
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-body">
            <form action="{{ route('profiles-upload.store') }}" method="post" id="createForm"  enctype="multipart/form-data">
            @csrf

            {{-- <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Title Ujian*</label>
                        <input type="text" class="form-control" name="title" placeholder="Title Ujian" value="{{ old('title') }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kategori" placeholder="Kategori Ujian" value="{{ old('kategori') }}" required>
                    </div>
                </div>
            </div> --}}
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Import Excel Profile</label>
