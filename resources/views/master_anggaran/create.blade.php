...
@section('content-title')
    <h1 class="m-0 text-warning">Create Master Anggaran</h1>
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-body">
            <form action="{{ route('master-anggaran.store') }}" method="post" id="createForm"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Nama Anggaran" value="{{ old('name') }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sawal" placeholder="Saldo Awal" value="{{ old('sawal') }}" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Saldo Akhir*</label>
                        <input type="text" class="form-control" name="sakir" placeholder="Saldo Akhir" value="{{ old('sakir') }}" required>
                    </div>
                </div>
            </div>
            {{-- <div class="row">
