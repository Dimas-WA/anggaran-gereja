...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-body">
            <form action="{{ route('routing-approvals.update', $app->id) }}" method="post" id="createForm" enctype="multipart/form-data">
            @csrf
                @method('PUT')
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>User*</label>
                        <input type="text" class="form-control" value="{{ $app->user->name }} - {{ $app->user->profile->seksi->name }}" disabled>
                        <input type="hidden" class="form-control" name="user" value="{{ $app->user->name }}" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status">
                            ...
                            <option value="1" {{ $app->active == 1 ? 'selected' : '' }} style="background-color: #339a74; color: white;">Aktif</option>
                            <option value="0" {{ $app->active == 0 ? 'selected' : '' }} style="background-color: #9a3333; color: white;">Tidak Aktif</option>
                        </select>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_2">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_2 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_3">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_3 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            <option value="0">none</option>
                        </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_4">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_4 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            <option value="0">none</option>
                        </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_5">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_5 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            <option value="0">none</option>
                        </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_6">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_6 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            <option value="0">none</option>
                        </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_7">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_7 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            <option value="0">none</option>
                        </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_8">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_8 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            <option value="0">none</option>
                        </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control select2bs4" style="width: 100%;" name="user_id_app_9">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $app->user_id_app_9 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            <option value="0">none</option>
                        </select>
                        </div>
